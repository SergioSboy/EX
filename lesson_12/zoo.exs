defmodule Zoo do
  ...
  defimpl Enumerable  do
    ...
    def reduce(%Zoo{animals: []}, {count, acc}, _fun), do: {:done, acc}
...
defmodule Main do
  def run do
    ...
    my_zoo = %Zoo{
      ...
      animals: [
        tiger,
        %Animal{species: "horse", name: "Zi", age: 2},
        %Animal{species: "deer", name: "Bambi", age: 1}
      ]
    }
  end
  ...
  my_zoo |> Enum.reduce(0, fn(animal, total_age) -> animal.age + total_age end) |> IO.puts
